		...
		<div class="container-fluid" id="main-container">
			...
			<div id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<ul class="submenu">
						<li class="active"><a href="${ctx}/DoubanMovieController/showRateTop/-1"><i class="icon-double-angle-right"></i> 年度最高评分</a></li>
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<div class="widget-header widget-header-flat widget-header-small">
							<h5><i class="icon-signal"></i>${year}年度评分最高的十部电影</h5>
							<div class="widget-toolbar no-border">
								...
								<ul class="dropdown-menu dropdown-info pull-right dropdown-caret">
									<li <c:if test="year == 所有" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/-1">所有</a></li>
									<li <c:if test="year == 2016" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/2016">2016</a></li>
									<li <c:if test="year == 2015" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/2015">2015</a></li>
									<li <c:if test="year == 2014" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/2014">2014</a></li>
									<li <c:if test="year == 2013" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/2013">2013</a></li>
									<li <c:if test="year == 2012" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showRateTop/2012">2012</a></li>
								</ul>
							</div>
						</div>
