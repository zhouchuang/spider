			...
			<div id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<ul class="submenu">
						...
						<li class="active"><a href="${ctx}/DoubanMovieController/showDirectFilms?direct="><i class="icon-double-angle-right"></i> 导演作品评分</a></li>
					  </ul>
					</li>
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						...
						<%-- <div class="widget-header widget-header-flat widget-header-small">
							<h5><i class="icon-signal"></i>${direct}作品集评论量</h5>
							<div class="widget-toolbar no-border">
								<button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown">${direct} <i class="icon-angle-down icon-on-right"></i></button>
								<ul class="dropdown-menu dropdown-info pull-right dropdown-caret">
									<c:forEach  items="${directlist}" var="movie">
										<li <c:if test="direct == movie.direct" >class="active"</c:if>  ><a href="${ctx}/DoubanMovieController/showDirectFilms?direct=${movie.direct}">${movie.direct}</a></li>
									</c:forEach>
								</ul>
							</div>
						</div>
						...
						<div class="widget-header widget-header-flat widget-header-small">
							<h5><i class="icon-signal"></i>${direct}作品集评分</h5>
							<div class="widget-toolbar no-border">
								<button class="btn btn-minier btn-primary dropdown-toggle" data-toggle="dropdown">${direct} <i class="icon-angle-down icon-on-right"></i></button>
								<ul class="dropdown-menu dropdown-info pull-right dropdown-caret">
									<c:forEach  items="${directlist}" var="movie">
